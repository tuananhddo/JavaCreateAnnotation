package com.annotations.SetterNotNull;
...
@SupportedAnnotationTypes("com.annotations.SetterNotNull")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
@AutoService(Processor.class)
public class SetterNotNullProcessor extends AbstractProcessor {
    @Override
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        processingEnv.getMessager().printMessage(Diagnostic.Kind.ERROR, "HUNCCCC");
        Set<? extends Element> rootE = roundEnv.getRootElements();

        for (TypeElement annotation : annotations) {

            processingEnv.getMessager().printMessage(Diagnostic.Kind.ERROR, "HMMMM");
...
//            List<Element> otherMethods = annotatedMethods.get(false);
            ...
            annotatedElements.forEach( element -> processingEnv.getMessager().printMessage(Diagnostic.Kind.ERROR, element.getSimpleName(), element));
